...
public final class SDK {
	 ...
	 */
    static final int widthBytes(int bitCount)
    {
     ...
     */
    static final int skipBytes(int bit, int width)
    {
     ...
     * @return 字节位
     */
    static final int colorCountToBitCount(int colorCount)
    {
	 ...
	 */
	static final String changeFileExtension(String fileName, String newExtension) {
	...
	static byte[][] palletes = new byte[256][4];
	static {
		palletes[0][0] = -1;//0;
		palletes[0][1] = 0;
		palletes[0][2] = 0;
